...
import { BiMenuAltLeft } from "react-icons/bi";
  ...
  return (
    <>
      <header className='px-5 py-3 md:px-16 md:py-6'>
        <nav className='flex items-center justify-between'>
          
            <h1 className='text-2xl font-extrabold italic py-1'>WESTON</h1>
            <BiMenuAltLeft className='text-4xl font-bold cursor-pointer hover:scale-110 hover:transition-all hover:duration-700 lg:hidden'/>
